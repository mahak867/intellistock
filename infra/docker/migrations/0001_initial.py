...
def upgrade() -> None:
    ...
    op.create_index("ix_predlog_ticker_created", "prediction_logs", ["ticker", "prediction_date"])
    ...
    op.create_index("ix_modelver_ticker_active", "model_versions", ["ticker", "is_active"])
